        ...
        <div class="body">
            <div class="body-content-wrap">
                ...
                <div class="single-input-wrap">
                    ...
                    <InputSingleValue
                        placeholder="이름"
                        on:change={(e) => changeHandle(e, user.name)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                    <InputSingleValue
                        placeholder="소속"
                        on:change={(e) => changeHandle(e, user.affiliation)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                </div>
                <div class="single-input-wrap">
                    ...
                    <InputSingleValue
                        placeholder="계급"
                        on:change={(e) => changeHandle(e, user.standing)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                    <InputSingleValue
                        placeholder="직별 혹은 직책"
                        on:change={(e) => changeHandle(e, user.position)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                </div>
                <div class="single-input-wrap">
                    ...
                    <InputSingleValue
                        placeholder="아이디"
                        on:change={(e) => changeHandle(e, user.registered_id)}
                        conditions={condition_set.registered_id_conditions}
                        on:pass={passHandle}
                    />
                    <InputSingleValue
                        placeholder="비밀번호"
                        on:change={(e) => changeHandle(e, user.password)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                </div>
                ...
                <div class="single-input-wrap">
                    ...
                    <InputSelectValue
                        placeholder="권한 종류"
                        init={1}
                        on:change={(e) => changeOptionHandle(e, user.authority)}
                    ...
                    <InputSingleValue
                        placeholder="등록 IP"
                        on:change={(e) => changeHandle(e, user.ip_address)}
                        conditions={condition_set.default_conditions}
                        on:pass={passHandle}
                    />
                </div>
