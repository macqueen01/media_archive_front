...
<div class="browse-content-container">
    {#if stage == 1}
        <div class="body">
            <div class="choice-wrap">
                <div class="choice" on:click={selectRequestType} on:mouseenter={() => focus = 1} on:mouseleave={() => focus = null}>
                    <div class="{(focus == 1) ? "background-container-focus" : "background-container"}">
                        <div class="svg-holder">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{(focus == 1) ? "white" : "rgb(31, 32, 88)"}" height="120px" width="120px">
                ...
                <div class="choice" on:click={selectRequestType} on:mouseenter={() => focus = 2} on:mouseleave={() => focus = null}>
                    <div class="{(focus == 2) ? "background-container-focus" : "background-container"}">
                        <div class="svg-holder">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="{(focus == 2) ? "white" : "rgb(31, 32, 88)"}" height="120px" width="120px">
    ...
    {:else if stage == 2}
        {#if request_type == 0}
            <AccessRequestContainer on:stageChange={stageChange} on:submit={submitData}/>
        {:else}
            <div class="authority-request"></div>
        {/if}
    {:else if stage == 3}
        {#if !submit_data}
